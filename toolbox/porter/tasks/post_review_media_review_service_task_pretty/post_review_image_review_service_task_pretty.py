...
@BaseTask.register("post_review_image_review_service_pretty")
class PostReviewImageReviewServiceTaskPretty(BaseTask):
    ...
    def _build_app(self) -> FastAPI:
        ...
        def api_media_stream(
            ...
            """代理拉取外链图片，根据平台调用对应的 FreshImageUrl 实现。"""
            ...
            return StreamingResponse(
                iter_chunks(), status_code=response.status_code, media_type=media_type, headers=resp_headers
            )
